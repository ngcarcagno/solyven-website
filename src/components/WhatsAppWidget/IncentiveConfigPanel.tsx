...
const IncentiveConfigPanel: React.FC<IncentiveConfigPanelProps> = ({ onConfigChange }) => {
  ...
  return (
    <>
      <ToggleButton onClick={() => setIsOpen(!isOpen)}>⚙️</ToggleButton>
          ...
          {config.messages.map((message) => (
            <div key={message.id} className="message-item">
              <div className="message-header">
                ...
                <div className="toggle">
                  <input type="checkbox" checked={message.enabled} onChange={() => toggleMessageEnabled(message.id)} />
                </div>
              </div>
